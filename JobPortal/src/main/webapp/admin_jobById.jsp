			...
			<div class="col-12">
				<div class="card" style="background-color: white; height: auto; box-shadow: 0px 10px 15px -10px rgba(0, 0, 0, 0.5),0px -5px 15px -5px rgba(0, 0, 0, 0.5); /* Top shadow */margin-left: 30px; margin-right: 30px; border-radius: 10px;" >
					...
					<div class="d-inline-block">
  						<a href="admin_user.jsp"><i class="fas fa-arrow-left d-inline ml-5" style="font-size: 25px;"></i></a> <!-- Back arrow icon -->
						<input class="form-control mt-3 search d-inline" id="search" type="text" placeholder="Search Jobs...." style="width:70%; margin-left: 9%;">
				</div>	
					<div class="row  ml-3 mr-3 mb-3 mt-3" id="container">
						...
						ArrayList<Jobs> ap = s1.getAdminJobById(request.getParameter("u_id"));													
									...
									<div class="row">
										...
										<div class="col-4 mt-1 mb-1 pr-0 border-start">
                        					...
                        					<div class="company-info">
                        						<span class="mr-4"><i class="bi bi-calendar-check-fill"></i> <%=j.getApplicationDeadline() %></span>
										...
										<div class="col-3 ">
											<div class="d-inline-block mt-4">
												<h4>Job ID: <%=j.getJobId() %></h4>
											</div>
											<div class="d-inline-block">
												<form action="register" method="post">
													<input type="hidden" value="<%=j.getJobId() %>" name="JobID">
													<input type="hidden" value="<%=request.getParameter("u_id") %>" name="uID">											
													<button class="buttonr" type="submit" name="AdminDeletejob"><b><i class="bi bi-trash"></i></b></button>
												</form>	
											</div>											
										</div>
