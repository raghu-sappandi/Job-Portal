...
<body style="background-color: #f9f9f9">
		...
		<div class="main">
			<center>
				...
				<div class="row">
					...
					<div class="col-1">
						<p style="margin-left: -40px;">>> Browse Jobs</p>
					</div>
					<div class="col-5"></div>
				</div>
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="row">
			<div class="col-12">
			<input class="form-control  search" id="search" type="text" placeholder="Search Jobs..." style="width:90%; margin-top: -20px; margin-left: 5%; height: 40px; border-radius: 10px;">
		</div>
        ...
        <div id="jobCards card" class="col-md-12 job-card" >
            <!-- Job Card 1 -->
...
<script>
    function toggleWishlist(jobId, currentAction) {
        // Get form and icon elements
        const form = document.getElementById('wishlistForm-' + jobId);
        const actionField = document.getElementById('wishlistAction-' + jobId);
        const icon = document.getElementById('wishlistIcon-' + jobId);

        // Toggle action between 'add' and 'remove'
        if (currentAction === 'add') {
            actionField.value = 'remove';
            icon.classList.remove('text-muted');
            icon.classList.add('text-danger'); // Change to filled heart
        } else {
            actionField.value = 'add';
            icon.classList.remove('text-danger');
            icon.classList.add('text-muted'); // Change to empty heart
        }
