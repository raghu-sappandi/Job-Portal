					...
					<div class="row mt-4">
						...
						<div class="col-12">
							 <div id="fresherCollapse" class="collapse">
    									...
    									<div class="col-3">
        									<div class=" form-floating mb-3 mt-3 ml-3 mr-3">
    											<input type="number" class="form-control" id="Cgpa" placeholder="Enter CGPA" name="CGPA" value="N/A" required>
    									...
    									<div class="col-3">
        									<div class=" form-floating mb-3 mt-3 ml-3 mr-3">
    											<input type="number" class="form-control" id="Backlog" placeholder="Enter Backlog" name="Backlog" value="1" required>
  							...
  							<div id="experiencedCollapse" class="collapse">
    							...
    							<div class="row">
    								...
    								<div class="col-6">
    									<div class=" form-floating mb-3 mt-3 ml-3 mr-3">
    											<input type="number" class="form-control" id="exp" placeholder="Enter Experience year" name="eyear" value="<%=seeker.getExperience() %>" required>
