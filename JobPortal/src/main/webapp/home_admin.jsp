...
<div style="height: 70px;"></div>
	<div class="row mt-5">
		...
		<div class="col-3" style="margin-left: 25px;">
			<div class="container ">
				...
				<i class="bi bi-graph-up"></i>	
				<h4 id="counter3" class="" style="margin-left: 130px;">0</h4>
				<h5 style="margin-left: 60px;"><b>Total Application's</b></h5>
				<div class="row mt-3">
					 	<div class="col-6">
					 		<h5 id="w3" class="" style="margin-left: 70px;"> <b> 0 </b> </h5>
					 		<h5 class="ml-4"><b>Last Week</b></h5>
					 	</div>
					 	<div class="col-6">
					 		<h5 id="m3" class="" style="margin-left: 40px;"> <b> 0 </b> </h5>
					 		<h5 class=""><b>Last Month</b></h5>
					 	</div>
					 </div>		
				</div>
	...
	<div class="row">
		<div class="col-1"></div>
		<div class="col-10">
			<div class="card" style="height:170px; width: 98%; margin-top: -30px; z-index: 0; margin-bottom: 30px; border-radius: 10px;">
				<div class="row">
					<div class="col-4">
						<div class="cad1">
