      ...
      <div class="forms-container">
        <div class="signin-signup">
          <form action="register" method="post" class="sign-in-form">
            ...
            <input type="submit" value="Submit" class="btn" name="forgotPass" />
          ...
          <form action="register" method="post" class="sign-up-form">
            ...
            <div class="input-field">
              <i class="fas fa-lock"></i>
              <input type="password" placeholder="Old Password" name="opw"/>
            </div>
            <div class="input-field">
              <i class="fas fa-lock"></i>
      ...
      <div class="panels-container">
        ...
        <div class="panel right-panel">
          <div class="content">
            ...
            <p>Click below to get back</p>
            <button class="btn transparent" id="sign-in-btn">Forgot</button>
          </div>
